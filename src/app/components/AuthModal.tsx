// Updated: Replaced mock auth with real Supabase Auth.
// Supports email/password login and registration. Google auth removed for now.
...
export function AuthModal() {
  const { login, register, isLoading, showAuthModal, setShowAuthModal, authRedirectPlanId, setAuthRedirectPlanId, user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        // Get user id from auth after login
